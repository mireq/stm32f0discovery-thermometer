...
SRCS = main.c core.cpp system_stm32f0xx.c
...
#CFLAGS  = -Wall -g -Os -fno-exceptions -nostartfiles -ffreestanding -fno-rtti
CFLAGS  = -Wall -g -Os -fno-exceptions -lstdc++
...
all: lib proj
	#arm-none-eabi-gdb --batch --command=run.gdb $(PROJ_NAME).elf
...
$(PROJ_NAME).elf: $(SRCS)
	$(CC) $(CFLAGS) $^ -o $@ -L$(STD_PERIPH_LIB) -lstm32f0 -L$(LDSCRIPT_INC) -Tstm32f0_ram.ld
...
program: $(PROJ_NAME).bin
	...
	#arm-none-eabi-gdb --batch --command=run.gdb main.elf
